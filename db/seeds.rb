...
LAST24 built with Javascript, CSS, HTML and Ruby on Rails using API from Twitter and Instagram (for content and oAuth). ",
    ...
    thumbnail_url: ["http://www.toangular.com/assets/apps/last24_hand.png",
                    "http://www.toangular.com/assets/apps/l24.png",
                    "http://www.toangular.com/assets/apps/l24_timeline.png",
                    "http://www.toangular.com/assets/apps/l24_instagram.png",
                    "http://www.toangular.com/assets/apps/l24_feed.png"],
    like: 0,
  ...
  { name: 'myBeautyCase',
    ...
    thumbnail_url: ["http://www.toangular.com/assets/apps/bc_user_profile.png",
                     "http://www.toangular.com/assets/apps/mb_hand.png",
                     "http://www.toangular.com/assets/apps/bc_brand.png",
                     "http://www.toangular.com/assets/apps/bc_user_summary.png",
                     "http://www.toangular.com/assets/apps/bc_users.png"],
    like: 0,
  ...
  { name: 'feedme',
    ...
    thumbnail_url: ["http://www.toangular.com/assets/apps/fm_hand.png",
                    "http://www.toangular.com/assets/apps/fm_order_with_movies.png",
                    "http://www.toangular.com/assets/apps/fm_yelp.png",
                    "http://www.toangular.com/assets/apps/fm_confirmation.png",
                    "http://www.toangular.com/assets/apps/fm_order_page.png",
                    "http://www.toangular.com/assets/apps/fm_order_summary.png",
                    "http://www.toangular.com/assets/apps/fm_order_summary2.png",
                    "http://www.toangular.com/assets/apps/fm_yelp_map.png"],
    like: 0,
